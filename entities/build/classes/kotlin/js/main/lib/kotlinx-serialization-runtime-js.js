(function (root, factory) {
  ...
  function CBOR(context, updateMode) {
    ...
    if (context === void 0)
      context = EmptyContext_getInstance();
  ...
  CBOR$Companion.prototype.dump_f4686g$ = function (saver, obj) {
    return this.plain.dump_f4686g$(saver, obj);
  };
  CBOR$Companion.prototype.dump_issdgt$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.cbor.CBOR.Companion.dump_issdgt$', wrapFunction(function () {
    ...
    return function (T_0, isT, obj) {
      var $this = this.plain;
      return $this.dump_f4686g$(getOrDefault($this.context, getKClass(T_0)), obj);
    };
  }));
  CBOR$Companion.prototype.dumps_issdgt$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.cbor.CBOR.Companion.dumps_issdgt$', wrapFunction(function () {
    ...
    return function (T_0, isT, obj) {
      var $this = this.plain;
      return internal.HexConverter.printHexBinary_1fhb37$($this.dump_f4686g$(getOrDefault($this.context, getKClass(T_0)), obj), true);
    };
  }));
  CBOR$Companion.prototype.load_u5ii4w$ = function (loader, raw) {
    return this.plain.load_u5ii4w$(loader, raw);
  };
  CBOR$Companion.prototype.load_5geitx$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.cbor.CBOR.Companion.load_5geitx$', wrapFunction(function () {
    ...
    return function (T_0, isT, raw) {
      var $this = this.plain;
      return $this.load_u5ii4w$(getOrDefault($this.context, getKClass(T_0)), raw);
    };
  }));
  ...
  AbstractCollectionSerializer.prototype.patch_mynpiu$ = function (input, old) {
    ...
    this.readSize_mes5ce$_0(input_0, builder);
    mainLoop: while (true) {
      var index = input_0.decodeElementIndex_qatsm0$(this.descriptor);
      switch (index) {
        case -2:
          this.readAll_uzk1f4$_0(input_0, builder, startIndex);
          break mainLoop;
        case -1:
          break mainLoop;
        default:this.readItem_gazzwn$(input_0, startIndex + index | 0, builder);
          break;
      }
    }
  ...
  AbstractCollectionSerializer.prototype.readAll_uzk1f4$_0 = function (input, builder, startIndex) {
    var size = this.readSize_mes5ce$_0(input, builder);
    if (!(size >= 0)) {
      var message = 'Size must be known in advance when using READ_ALL';
      throw IllegalArgumentException_init(message.toString());
    }
    for (var index = 0; index < size; index++)
      this.readItem_gazzwn$(input, startIndex + index | 0, builder);
  };
  ...
  ListLikeSerializer.prototype.readItem_gazzwn$ = function (input, index, builder) {
  ...
  MapLikeSerializer.prototype.readItem_gazzwn$ = function (input, index, builder) {
    var tmp$;
    var key = input.decodeSerializableElement_s44l7r$(this.descriptor, index, this.keySerializer);
    var vIndex = input.decodeElementIndex_qatsm0$(this.descriptor);
    if (!(vIndex === (index + 1 | 0))) {
      var message = 'Value must follow key in a map, index for key: ' + index + ', returned index for value: ' + vIndex;
      throw IllegalArgumentException_init(message.toString());
    }
    if (builder.containsKey_11rb$(key) && !Kotlin.isType(this.valueSerializer.descriptor.kind, PrimitiveKind)) {
      tmp$ = input.updateSerializableElement_ehubvl$(this.descriptor, vIndex, this.valueSerializer, getValue(builder, key));
    }
     else {
      tmp$ = input.decodeSerializableElement_s44l7r$(this.descriptor, vIndex, this.valueSerializer);
    }
    var value = tmp$;
  ...
  JSON_0.prototype.stringify_tf03ej$ = function (saver, obj) {
  ...
  JSON_0.prototype.stringify_issdgt$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.json.JSON.stringify_issdgt$', wrapFunction(function () {
    ...
    var getOrDefault = _.kotlinx.serialization.context.getOrDefault_6qy6ah$;
    return function (T_0, isT, obj) {
      return this.stringify_tf03ej$(getOrDefault(this.context, getKClass(T_0)), obj);
    };
  }));
  JSON_0.prototype.stringify_i5tj4i$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.json.JSON.stringify_i5tj4i$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
    var getOrDefault = _.kotlinx.serialization.context.getOrDefault_6qy6ah$;
    var get_list = _.kotlinx.serialization.get_list_gekvwj$;
    return function (T_0, isT, objects) {
      return this.stringify_tf03ej$(get_list(getOrDefault(this.context, getKClass(T_0))), objects);
    };
  }));
  JSON_0.prototype.stringify_v42red$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.json.JSON.stringify_v42red$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
    var getOrDefault = _.kotlinx.serialization.context.getOrDefault_6qy6ah$;
    var to = Kotlin.kotlin.to_ujzrz7$;
    var get_map = _.kotlinx.serialization.get_map_kgqhr1$;
    return function (K_0, isK, V_0, isV, map) {
      return this.stringify_tf03ej$(get_map(to(getOrDefault(this.context, getKClass(K_0)), getOrDefault(this.context, getKClass(V_0)))), map);
    };
  }));
  JSON_0.prototype.parse_awif5v$ = function (loader, str) {
    var parser = new Parser(str);
    var input = new JSON$JsonInput(this, Mode$OBJ_getInstance(), parser);
    var result = decode_0(input, loader);
    if (!(parser.tc === TC_EOF)) {
  ...
  JSON_0.prototype.parse_3zqiyt$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.json.JSON.parse_3zqiyt$', wrapFunction(function () {
    ...
    return function (T_0, isT, str) {
      return this.parse_awif5v$(getOrDefault(this.context, getKClass(T_0)), str);
    };
  }));
  JSON_0.prototype.parseList_3zqiyt$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.json.JSON.parseList_3zqiyt$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
    var getOrDefault = _.kotlinx.serialization.context.getOrDefault_6qy6ah$;
    var get_list = _.kotlinx.serialization.get_list_gekvwj$;
    return function (T_0, isT, objects) {
      return this.parse_awif5v$(get_list(getOrDefault(this.context, getKClass(T_0))), objects);
    };
  }));
  JSON_0.prototype.parseMap_1gr3s3$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.json.JSON.parseMap_1gr3s3$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
    var getOrDefault = _.kotlinx.serialization.context.getOrDefault_6qy6ah$;
    var to = Kotlin.kotlin.to_ujzrz7$;
    var get_map = _.kotlinx.serialization.get_map_kgqhr1$;
    return function (K_0, isK, V_0, isV, map) {
      return this.parse_awif5v$(get_map(to(getOrDefault(this.context, getKClass(K_0)), getOrDefault(this.context, getKClass(V_0)))), map);
    };
  }));
  ...
  JSON$Companion.prototype.stringify_tf03ej$ = function (saver, obj) {
    return this.plain.stringify_tf03ej$(saver, obj);
  };
  JSON$Companion.prototype.stringify_issdgt$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.json.JSON.Companion.stringify_issdgt$', wrapFunction(function () {
    ...
    var serializer = _.kotlinx.serialization.serializer_1yb8b7$;
    return function (T_0, isT, obj) {
      return this.stringify_tf03ej$(serializer(getKClass(T_0)), obj);
    };
  }));
  JSON$Companion.prototype.stringify_i5tj4i$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.json.JSON.Companion.stringify_i5tj4i$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
    var serializer = _.kotlinx.serialization.serializer_1yb8b7$;
    var get_list = _.kotlinx.serialization.get_list_gekvwj$;
    return function (T_0, isT, objects) {
      return this.stringify_tf03ej$(get_list(serializer(getKClass(T_0))), objects);
    };
  }));
  JSON$Companion.prototype.stringify_v42red$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.json.JSON.Companion.stringify_v42red$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
    var serializer = _.kotlinx.serialization.serializer_1yb8b7$;
    var to = Kotlin.kotlin.to_ujzrz7$;
    var get_map = _.kotlinx.serialization.get_map_kgqhr1$;
    return function (K_0, isK, V_0, isV, map) {
      return this.stringify_tf03ej$(get_map(to(serializer(getKClass(K_0)), serializer(getKClass(V_0)))), map);
    };
  }));
  JSON$Companion.prototype.parse_awif5v$ = function (loader, str) {
    return this.plain.parse_awif5v$(loader, str);
  };
  JSON$Companion.prototype.parse_3zqiyt$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.json.JSON.Companion.parse_3zqiyt$', wrapFunction(function () {
    ...
    var serializer = _.kotlinx.serialization.serializer_1yb8b7$;
    return function (T_0, isT, str) {
      return this.parse_awif5v$(serializer(getKClass(T_0)), str);
    };
  }));
  JSON$Companion.prototype.parseList_3zqiyt$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.json.JSON.Companion.parseList_3zqiyt$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
    var serializer = _.kotlinx.serialization.serializer_1yb8b7$;
    var get_list = _.kotlinx.serialization.get_list_gekvwj$;
    return function (T_0, isT, objects) {
      return this.parse_awif5v$(get_list(serializer(getKClass(T_0))), objects);
    };
  }));
  JSON$Companion.prototype.parseMap_1gr3s3$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.json.JSON.Companion.parseMap_1gr3s3$', wrapFunction(function () {
    var getKClass = Kotlin.getKClass;
    var serializer = _.kotlinx.serialization.serializer_1yb8b7$;
    var to = Kotlin.kotlin.to_ujzrz7$;
    var get_map = _.kotlinx.serialization.get_map_kgqhr1$;
    return function (K_0, isK, V_0, isV, map) {
      return this.parse_awif5v$(get_map(to(serializer(getKClass(K_0)), serializer(getKClass(V_0)))), map);
    };
  }));
  ...
  Mapper.prototype.map_issdgt$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.Mapper.map_issdgt$', wrapFunction(function () {
    ...
    return function (T_0, isT, obj) {
      ...
      encode(m, serializer(getKClass(T_0)), obj);
      return m.map;
    };
  }));
  ...
  Mapper.prototype.unmap_67iyj5$ = defineInlineFunction('kotlinx-serialization-runtime-js.kotlinx.serialization.Mapper.unmap_67iyj5$', wrapFunction(function () {
    ...
    return function (T_0, isT, map) {
      ...
      return decode(m, serializer(getKClass(T_0)));
    };
  }));
  ...
  ProtoBuf$Companion.prototype.dump_f4686g$ = function (saver, obj) {
    return this.plain.dump_f4686g$(saver, obj);
  };
  ...
  ProtoBuf$Companion.prototype.load_u5ii4w$ = function (loader, raw) {
    return this.plain.load_u5ii4w$(loader, raw);
  };
  ...
  ProtoBuf.prototype.dump_f4686g$ = function (saver, obj) {
    var output = ByteArrayOutputStream_init();
  ...
  ProtoBuf.prototype.load_u5ii4w$ = function (loader, raw) {
    var stream = ByteArrayInputStream_init(raw);
  ...
  ValueTransformer$Output.prototype.encodeElement_3zr2iy$ = function (desc, index) {
    return true;
  };
  ...
  ValueTransformer$Output.prototype.beginCollection_gly1x5$ = Encoder.prototype.beginCollection_gly1x5$;
  ...
  ValueTransformer$Input.prototype.decodeCollectionSize_qatsm0$ = CompositeDecoder.prototype.decodeCollectionSize_qatsm0$;
