(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    define(['exports', 'kotlin', 'kotlinx-io-js', 'ktor-utils-js', 'kotlinx-coroutines-io-js', 'kotlinx-coroutines-core'], factory);
  else if (typeof exports === 'object')
    factory(module.exports, require('kotlin'), require('kotlinx-io-js'), require('ktor-utils-js'), require('kotlinx-coroutines-io-js'), require('kotlinx-coroutines-core'));
  else {
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'ktor-http-js'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'ktor-http-js'.");
    }
    if (typeof this['kotlinx-io-js'] === 'undefined') {
      throw new Error("Error loading module 'ktor-http-js'. Its dependency 'kotlinx-io-js' was not found. Please, check whether 'kotlinx-io-js' is loaded prior to 'ktor-http-js'.");
    }
    if (typeof this['ktor-utils-js'] === 'undefined') {
      throw new Error("Error loading module 'ktor-http-js'. Its dependency 'ktor-utils-js' was not found. Please, check whether 'ktor-utils-js' is loaded prior to 'ktor-http-js'.");
    }
    if (typeof this['kotlinx-coroutines-io-js'] === 'undefined') {
      throw new Error("Error loading module 'ktor-http-js'. Its dependency 'kotlinx-coroutines-io-js' was not found. Please, check whether 'kotlinx-coroutines-io-js' is loaded prior to 'ktor-http-js'.");
    }
    if (typeof this['kotlinx-coroutines-core'] === 'undefined') {
      throw new Error("Error loading module 'ktor-http-js'. Its dependency 'kotlinx-coroutines-core' was not found. Please, check whether 'kotlinx-coroutines-core' is loaded prior to 'ktor-http-js'.");
    }
    root['ktor-http-js'] = factory(typeof this['ktor-http-js'] === 'undefined' ? {} : this['ktor-http-js'], kotlin, this['kotlinx-io-js'], this['ktor-utils-js'], this['kotlinx-coroutines-io-js'], this['kotlinx-coroutines-core']);
  }
}(this, function (_, Kotlin, $module$kotlinx_io_js, $module$ktor_utils_js, $module$kotlinx_coroutines_io_js, $module$kotlinx_coroutines_core) {
  'use strict';
  ...
  var encode = $module$kotlinx_io_js.kotlinx.io.charsets.encode_478lbv$;
  var toChar = Kotlin.toChar;
  var Unit = Kotlin.kotlin.Unit;
  var StringBuilder_init = Kotlin.kotlin.text.StringBuilder_init_za3lpa$;
  var String_0 = $module$kotlinx_io_js.kotlinx.io.core.String_37vbci$;
  ...
  var get_name = $module$kotlinx_io_js.kotlinx.io.charsets.get_name_vfm6x$;
  ...
  var encodeBase64 = $module$ktor_utils_js.io.ktor.util.encodeBase64_pdl1vz$;
  var decodeBase64 = $module$ktor_utils_js.io.ktor.util.decodeBase64_pdl1vz$;
  var isWhitespace = Kotlin.kotlin.text.isWhitespace_myv2d0$;
  var wrapFunction = Kotlin.wrapFunction;
  var Month = $module$ktor_utils_js.io.ktor.util.date.Month;
  var GMTDate = $module$ktor_utils_js.io.ktor.util.date.GMTDate_qlqxlw$;
  var toCharArray = $module$ktor_utils_js.io.ktor.util.toCharArray_pdl1vz$;
  ...
  var caseInsensitiveMap = $module$ktor_utils_js.io.ktor.util.caseInsensitiveMap_287e2$;
  ...
  var StringValues = $module$ktor_utils_js.io.ktor.util.StringValues;
  var StringValuesBuilder = $module$ktor_utils_js.io.ktor.util.StringValuesBuilder;
  var emptySet = Kotlin.kotlin.collections.emptySet_287e2$;
  var listOf_0 = Kotlin.kotlin.collections.listOf_mh5how$;
  var asList = Kotlin.kotlin.collections.asList_us0mfu$;
  var toMap_0 = Kotlin.kotlin.collections.toMap_6hr0sd$;
  var StringValuesImpl = $module$ktor_utils_js.io.ktor.util.StringValuesImpl;
  var StringValuesSingleImpl = $module$ktor_utils_js.io.ktor.util.StringValuesSingleImpl;
  ...
  var contains_0 = $module$ktor_utils_js.io.ktor.util.contains_9p7nab$;
  var filterNotNull = Kotlin.kotlin.collections.filterNotNull_emfgvx$;
  var ensureNotNull = Kotlin.ensureNotNull;
  var IllegalStateException = Kotlin.kotlin.IllegalStateException;
  var isLowerCase = $module$ktor_utils_js.io.ktor.util.isLowerCase_myv2d0$;
  ...
  var copyTo = $module$kotlinx_coroutines_io_js.kotlinx.coroutines.io.copyTo_lhug7f$;
  ...
  function contentType($receiver, contentType) {
    throw new NotImplementedError_init('An operation is not implemented: ' + 'Not supported anymore');
  }
  ...
  function CacheControl$Visibility$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant io.ktor.http.CacheControl.Visibility.' + name);
    }
  }
  ...
  function CookieEncoding$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant io.ktor.http.CookieEncoding.' + name);
    }
  }
  ...
  HeaderValueWithParameters.prototype.toString = function () {
    if (this.parameters.isEmpty())
      ...
      while (tmp$_1.hasNext()) {
        ...
        $receiver.append_gw00v9$('=');
        escapeIfNeededTo(value, $receiver);
      }
      return $receiver.toString();
    }
  };
  ...
  HeaderValueWithParameters$Companion.prototype.parse_g5gu5m$ = defineInlineFunction('ktor-http-js.io.ktor.http.HeaderValueWithParameters.Companion.parse_g5gu5m$', wrapFunction(function () {
  ...
  var CHARACTERS_SHOULD_BE_ESCAPED;
  function escapeIfNeeded($receiver) {
    if (indexOfAny($receiver, CHARACTERS_SHOULD_BE_ESCAPED) !== -1)
  ...
  Headers$Companion.prototype.build_g6xk4w$ = defineInlineFunction('ktor-http-js.io.ktor.http.Headers.Companion.build_g6xk4w$', wrapFunction(function () {
  ...
  function contentLength_2($receiver) {
    var tmp$;
    return (tmp$ = $receiver.headers.get_61zpoe$(HttpHeaders_getInstance().ContentLength)) != null ? toLong(tmp$) : null;
  }
  ...
  var get_ExceptionFailed = defineInlineFunction('ktor-http-js.io.ktor.http.get_ExceptionFailed_i80ybi$', function ($receiver) {
  ...
  function formUrlEncodeTo($receiver, out) {
    ...
    joinTo(destination, out, '&', void 0, void 0, void 0, void 0, formUrlEncodeTo$lambda);
  }
  ...
  Parameters$Companion.prototype.build_itqcaa$ = defineInlineFunction('ktor-http-js.io.ktor.http.Parameters.Companion.build_itqcaa$', wrapFunction(function () {
  ...
  function RangeUnits$valueOf(name) {
    switch (name) {
      ...
      default:throwISE('No enum constant io.ktor.http.RangeUnits.' + name);
    }
  }
  ...
  function takeFromUnsafe($receiver, urlString) {
    ...
    var pathEnd = (tmp$_0 = $receiver_1 > 0 ? $receiver_1 : null) != null ? tmp$_0 : endIndex;
    ...
    if (startIndex < endIndex && urlString.charCodeAt(startIndex) === 63) {
      ...
      var $receiver_2 = indexOf(urlString, 35, startIndex + 1 | 0);
      var fragmentStart = (tmp$_1 = $receiver_2 > 0 ? $receiver_2 : null) != null ? tmp$_1 : endIndex;
  ...
  function findScheme(urlString, startIndex, endIndex) {
    ...
    while (current < endIndex) {
      if (urlString.charCodeAt(current) === 58)
        return current;
      current = current + 1 | 0;
    }
    return -1;
  ...
  var flatten = defineInlineFunction('ktor-http-js.io.ktor.http.parsing.flatten_mtaoqd$', wrapFunction(function () {
    var Unit = Kotlin.kotlin.Unit;
    var wrapFunction = Kotlin.wrapFunction;
    var flatten$lambda = wrapFunction(function () {
      var addAll = Kotlin.kotlin.collections.addAll_ipc267$;
  ...
  package$http.contentType_wrzasr$ = contentType;
  package$http.contentLength_1ixemd$ = contentLength;
  ...
  $$importsForInline$$['ktor-http-js'] = _;
  ...
  package$http.contentType_41kwpe$ = contentType_0;
  package$http.contentLength_yd9j87$ = contentLength_0;
  ...
  package$http.contentLength_jzzg3d$ = contentLength_1;
  ...
  package$http.contentLength_v1wgmc$ = contentLength_2;
  ...
  CHARACTERS_SHOULD_BE_ESCAPED = toCharArray('"=;,\\/ ');
  ...
  Kotlin.defineModule('ktor-http-js', _);
  return _;
}));

//# sourceMappingURL=ktor-http-js.js.map
