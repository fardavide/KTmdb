(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'kotlinx-coroutines-io-js'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'kotlinx-coroutines-io-js'.");
    }
    if (typeof this['kotlinx-io-js'] === 'undefined') {
      throw new Error("Error loading module 'kotlinx-coroutines-io-js'. Its dependency 'kotlinx-io-js' was not found. Please, check whether 'kotlinx-io-js' is loaded prior to 'kotlinx-coroutines-io-js'.");
    }
    if (typeof this['kotlinx-coroutines-core'] === 'undefined') {
      throw new Error("Error loading module 'kotlinx-coroutines-io-js'. Its dependency 'kotlinx-coroutines-core' was not found. Please, check whether 'kotlinx-coroutines-core' is loaded prior to 'kotlinx-coroutines-io-js'.");
    }
    root['kotlinx-coroutines-io-js'] = factory(typeof this['kotlinx-coroutines-io-js'] === 'undefined' ? {} : this['kotlinx-coroutines-io-js'], kotlin, this['kotlinx-io-js'], this['kotlinx-coroutines-core']);
  }
}(this, function (_, Kotlin, $module$kotlinx_io_js, $module$kotlinx_coroutines_core) {
  'use strict';
  var $$importsForInline$$ = _.$$importsForInline$$ || (_.$$importsForInline$$ = {});
  var IoBuffer = $module$kotlinx_io_js.kotlinx.io.core.IoBuffer;
  var COROUTINE_SUSPENDED = Kotlin.kotlin.coroutines.intrinsics.COROUTINE_SUSPENDED;
  var CoroutineImpl = Kotlin.kotlin.coroutines.CoroutineImpl;
  var throwCCE = Kotlin.throwCCE;
  var Long$Companion$MAX_VALUE = Kotlin.Long.MAX_VALUE;
  var Unit = Kotlin.kotlin.Unit;
  var EOFException = $module$kotlinx_io_js.kotlinx.io.core.EOFException;
  var Kind_CLASS = Kotlin.Kind.CLASS;
  var lazy = Kotlin.kotlin.lazy_klfg04$;
  var Kind_OBJECT = Kotlin.Kind.OBJECT;
  var Kind_INTERFACE = Kotlin.Kind.INTERFACE;
  var handleCoroutineException = $module$kotlinx_coroutines_core.kotlinx.coroutines.handleCoroutineException_qb3u6s$;
  var AbstractCoroutine = $module$kotlinx_coroutines_core.kotlinx.coroutines.AbstractCoroutine;
  ...
  var $unsafeAppend$ = $module$kotlinx_io_js.kotlinx.io.core.internal.$unsafeAppend$_a3tlu$;
  var writeFully = $module$kotlinx_io_js.kotlinx.io.core.writeFully_bc6dmu$;
  var BytePacketBuilder = $module$kotlinx_io_js.kotlinx.io.core.BytePacketBuilder_za3lpa$;
  var ensureNotNull = Kotlin.ensureNotNull;
  var toByte = Kotlin.toByte;
  var decodeUTF8LineLoopSuspend = $module$kotlinx_io_js.kotlinx.io.core.internal.decodeUTF8LineLoopSuspend_a47po6$;
  var StringBuilder_init = Kotlin.kotlin.text.StringBuilder_init;
  var CancellationException = $module$kotlinx_coroutines_core.kotlinx.coroutines.CancellationException;
  var ByteReadPacket_init = $module$kotlinx_io_js.kotlinx.io.core.ByteReadPacket_init_3npcxq$;
  var L4088 = Kotlin.Long.fromInt(4088);
  var ByteOrder = $module$kotlinx_io_js.kotlinx.io.core.ByteOrder;
  ...
  ByteChannelCoroutine.prototype = Object.create(AbstractCoroutine.prototype);
  ByteChannelCoroutine.prototype.constructor = ByteChannelCoroutine;
  ...
  ReaderCoroutine.prototype = Object.create(ByteChannelCoroutine.prototype);
  ReaderCoroutine.prototype.constructor = ReaderCoroutine;
  WriterCoroutine.prototype = Object.create(ByteChannelCoroutine.prototype);
  WriterCoroutine.prototype.constructor = WriterCoroutine;
  ...
  function ByteReadChannel(content, offset, length) {
    ...
    return new ByteChannelJS(head, false);
  }
      ...
      try {
        switch (this.state_0) {
          case 0:
            var tmp$, tmp$_0;
            this.state_0 = 2;
            this.result_0 = joinTo_0(Kotlin.isType(tmp$ = this.local$$receiver, ByteChannelSequentialBase) ? tmp$ : throwCCE(), Kotlin.isType(tmp$_0 = this.local$dst, ByteChannelSequentialBase) ? tmp$_0 : throwCCE(), this.local$closeOnEnd, this);
  ...
  function copyTo($receiver, dst, limit, continuation) {
    ...
    var tmp$, tmp$_0;
    return copyTo_0(Kotlin.isType(tmp$ = $receiver, ByteChannelSequentialBase) ? tmp$ : throwCCE(), Kotlin.isType(tmp$_0 = dst, ByteChannelSequentialBase) ? tmp$_0 : throwCCE(), void 0, continuation);
  }
  ...
  function ByteChannelJS$attachJob$lambda(this$ByteChannelJS) {
    return function (cause) {
      ...
      if (cause != null)
        cancel(this$ByteChannelJS);
      return Unit;
    };
  }
  ByteChannelJS.prototype.attachJob_dqr1mp$ = function (job) {
    var tmp$;
    (tmp$ = this.attachedJob_0) != null ? tmp$.cancel() : null;
  ...
  function ByteChannelCoroutine(parentContext, channel) {
    AbstractCoroutine.call(this, parentContext, true);
    this.channel_ht0tr8$_0 = channel;
  }
  Object.defineProperty(ByteChannelCoroutine.prototype, 'channel', {
    get: function () {
      return this.channel_ht0tr8$_0;
    }
  });
  ByteChannelCoroutine.prototype.onCancellation_dbl4no$ = function (cause) {
    if (!this.channel.close_dbl4no$(cause) && cause != null)
      handleCoroutineException(this.context, cause);
  };
  ByteChannelCoroutine.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ByteChannelCoroutine',
    interfaces: [AbstractCoroutine]
  };
  function ByteChannel_0() {
  }
  ByteChannel_0.$metadata$ = {
    kind: Kind_INTERFACE,
    simpleName: 'ByteChannel',
    interfaces: [ByteWriteChannel, ByteReadChannel_1]
  };
  var encodeToByteArray = $module$kotlinx_io_js.kotlinx.io.charsets.encodeToByteArray_478lbv$;
  function ByteReadChannel_2(text, charset) {
    if (charset === void 0)
  ...
  function joinTo_0($receiver_0, dst_0, closeOnEnd_0, continuation_0, suspended) {
    var instance = new Coroutine$joinTo_0($receiver_0, dst_0, closeOnEnd_0, continuation_0);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$joinTo_0($receiver_0, dst_0, closeOnEnd_0, continuation_0) {
    CoroutineImpl.call(this, continuation_0);
    this.exceptionState_0 = 1;
    this.local$$receiver = $receiver_0;
    this.local$dst = dst_0;
  ...
  Coroutine$joinTo_0.$metadata$ = {
    kind: Kotlin.Kind.CLASS,
    simpleName: null,
    interfaces: [CoroutineImpl]
  };
  Coroutine$joinTo_0.prototype = Object.create(CoroutineImpl.prototype);
  Coroutine$joinTo_0.prototype.constructor = Coroutine$joinTo_0;
  Coroutine$joinTo_0.prototype.doResume = function () {
    do
      try {
        switch (this.state_0) {
          case 0:
            this.state_0 = 2;
            this.result_0 = copyTo_0(this.local$$receiver, this.local$dst, void 0, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function copyTo_0($receiver_0, dst_0, limit_0, continuation_0, suspended) {
  ...
  ByteChannelSequentialBase$writeSuspendSession$ObjectLiteral.prototype.request_za3lpa$ = function (min) {
    if (this.this$ByteChannelSequentialBase.availableForWrite === 0)
      return null;
    return this.this$ByteChannelSequentialBase.writable.$prepareWrite$_za3lpa$(min);
  };
  ByteChannelSequentialBase$writeSuspendSession$ObjectLiteral.prototype.written_za3lpa$ = function (n) {
    this.this$ByteChannelSequentialBase.writable.$afterWrite$();
  ...
  ByteChannelSequentialBase.prototype.completeReading_jdkw5m$_0 = function () {
    ...
    if (this.lastReadView_g6geey$_0 !== IoBuffer.Companion.Empty) {
      this.readable.$updateRemaining$_za3lpa$(remaining);
    }
    if (delta > 0) {
      this.afterRead();
    }
      ...
      try {
        switch (this.state_0) {
          ...
          case 2:
            ...
            return !this.$this.isClosedForRead;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
      }
  ...
  ByteChannelSequentialBase.prototype.request_za3lpa$$default = function (atLeast) {
    ...
    this.completeReading_jdkw5m$_0();
    var view = this.readable.$prepareRead$_za3lpa$(atLeast);
    if (view == null) {
      this.lastReadView_g6geey$_0 = IoBuffer.Companion.Empty;
      this.lastReadAvailable_rm45jo$_0 = 0;
    }
  ...
  ByteChannelSequentialBase.$metadata$ = {
    ...
    interfaces: [SuspendableReadSession, ByteChannel_0, ByteWriteChannel, ByteReadChannel_1]
  };
  ...
  function discardExact($receiver, n, continuation, suspended) {
    var instance = new Coroutine$discardExact($receiver, n, continuation);
    if (suspended)
      return instance;
    else
      return instance.doResume(null);
  }
  function Coroutine$discardExact($receiver, n, continuation) {
        ...
        switch (this.state_0) {
          ...
          case 2:
            if (!equals(this.result_0, this.local$n))
              throw new EOFException_init('Unable to discard ' + this.local$n.toString() + ' bytes');
            return;
          default:this.state_0 = 1;
            throw new Error('State Machine Unreachable execution');
        }
  ...
  defineInlineFunction('kotlinx-coroutines-io-js.kotlinx.coroutines.io.discardExact_5joj65$', wrapFunction(function () {
    var COROUTINE_SUSPENDED = Kotlin.kotlin.coroutines.intrinsics.COROUTINE_SUSPENDED;
    var CoroutineImpl = Kotlin.kotlin.coroutines.CoroutineImpl;
    var equals = Kotlin.equals;
    var EOFException_init = _.$$importsForInline$$['kotlinx-io-js'].kotlinx.io.core.EOFException;
        ...
        switch (this.state_0) {
          case 0:
            if (this.local$limit === void 0)
              this.local$limit = Long$Companion$MAX_VALUE;
            this.state_0 = 2;
            this.result_0 = copyTo(this.local$$receiver, this.local$dst, this.local$limit, this);
            if (this.result_0 === COROUTINE_SUSPENDED)
              return COROUTINE_SUSPENDED;
            continue;
          case 1:
  ...
  function writePacket($receiver_0, headerSizeHint_0, builder_0, continuation) {
    if (headerSizeHint_0 === void 0)
      headerSizeHint_0 = 0;
    var buildPacket$result;
    var builder_0 = BytePacketBuilder(headerSizeHint_0);
    try {
      builder_0(builder_0);
      buildPacket$result = builder_0.build();
    }
     catch (t) {
      if (Kotlin.isType(t, Throwable)) {
        builder_0.release();
    ...
    return $receiver_0.writePacket_8awntw$(buildPacket$result, continuation);
  }
  defineInlineFunction('kotlinx-coroutines-io-js.kotlinx.coroutines.io.writePacket_okw089$', wrapFunction(function () {
    var COROUTINE_SUSPENDED = Kotlin.kotlin.coroutines.intrinsics.COROUTINE_SUSPENDED;
    var CoroutineImpl = Kotlin.kotlin.coroutines.CoroutineImpl;
    var BytePacketBuilder = _.$$importsForInline$$['kotlinx-io-js'].kotlinx.io.core.BytePacketBuilder_za3lpa$;
    var Throwable = Error;
    return function ($receiver_0, headerSizeHint_0, builder_0, continuation) {
      if (headerSizeHint_0 === void 0)
        headerSizeHint_0 = 0;
      var buildPacket$result;
      var builder_1 = BytePacketBuilder(headerSizeHint_0);
      try {
        builder_0(builder_1);
        buildPacket$result = builder_1.build();
      }
       catch (t) {
        if (Kotlin.isType(t, Throwable)) {
          builder_1.release();
      ...
      Kotlin.suspendCall($receiver_0.writePacket_8awntw$(buildPacket$result, Kotlin.coroutineReceiver()));
  ...
  function reader($receiver, coroutineContext, channel, block) {
    var newContext = newCoroutineContext($receiver, coroutineContext);
    var $receiver_0 = new ReaderCoroutine(newContext, channel);
    $receiver_0.start_b5ul0p$(CoroutineStart.DEFAULT, $receiver_0, block);
    return $receiver_0;
  }
  function reader_0($receiver, coroutineContext, autoFlush, block) {
    var channel = ByteChannel(autoFlush);
    var $receiver_0 = reader($receiver, coroutineContext, channel, block);
    channel.attachJob_dqr1mp$($receiver_0);
    return $receiver_0;
  }
  function reader_1(coroutineContext, channel, parent, block) {
    if (parent === void 0)
      parent = null;
    var newContext = parent != null ? newCoroutineContext(coroutines.GlobalScope, coroutineContext.plus_1fupul$(parent)) : newCoroutineContext(coroutines.GlobalScope, coroutineContext);
    var $receiver = new ReaderCoroutine(newContext, channel);
    $receiver.start_b5ul0p$(CoroutineStart.DEFAULT, $receiver, block);
    return $receiver;
  }
  ...
  function writer($receiver, coroutineContext, channel, block) {
    var newContext = newCoroutineContext($receiver, coroutineContext);
    var $receiver_0 = new WriterCoroutine(newContext, channel);
    $receiver_0.start_b5ul0p$(CoroutineStart.DEFAULT, $receiver_0, block);
    return $receiver_0;
  }
  function writer_0($receiver, coroutineContext, autoFlush, block) {
    if (autoFlush === void 0)
      autoFlush = false;
    var channel = ByteChannel(autoFlush);
    var $receiver_0 = writer($receiver, coroutineContext, channel, block);
    channel.attachJob_dqr1mp$($receiver_0);
    return $receiver_0;
  }
  function writer_1(coroutineContext, channel, parent, block) {
    if (parent === void 0)
      parent = null;
    var newContext = parent != null ? newCoroutineContext(coroutines.GlobalScope, coroutineContext.plus_1fupul$(parent)) : newCoroutineContext(coroutines.GlobalScope, coroutineContext);
    var $receiver = new WriterCoroutine(newContext, channel);
    $receiver.start_b5ul0p$(CoroutineStart.DEFAULT, $receiver, block);
    return $receiver;
  }
  ...
  function ReaderCoroutine(context, channel) {
    ByteChannelCoroutine.call(this, context, channel);
  }
  ReaderCoroutine.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'ReaderCoroutine',
    interfaces: [ReaderScope, ReaderJob, ByteChannelCoroutine]
  };
  function WriterCoroutine(ctx, channel) {
    ByteChannelCoroutine.call(this, ctx, channel);
  }
  WriterCoroutine.$metadata$ = {
    kind: Kind_CLASS,
    simpleName: 'WriterCoroutine',
    interfaces: [WriterJob, WriterScope, ByteChannelCoroutine]
  };
  ...
  function ByteReadChannel_3(content, offset, length) {
    if (offset === void 0)
      offset = 0;
    if (length === void 0)
      length = content.length;
    return ByteReadChannel(content, offset, length);
  }
  function ByteReadChannel_4(text, charset) {
    if (charset === void 0)
      charset = charsets.Charsets.UTF_8;
    return ByteReadChannel_2(text, charset);
  }
  ...
  package$io.ByteChannel_6taknv$ = ByteChannel;
  package$io.ByteReadChannel_mj6st8$ = ByteReadChannel;
  package$io.ByteReadChannel_c2mund$ = ByteReadChannel_0;
  package$io.joinTo_ulwomx$ = joinTo;
  package$io.copyTo_lhug7f$ = copyTo;
  package$io.ByteChannelJS = ByteChannelJS;
  Object.defineProperty(ByteReadChannel_1, 'Companion', {
    get: ByteReadChannel$Companion_getInstance
  });
  package$io.ByteReadChannel = ByteReadChannel_1;
  package$io.ByteWriteChannel = ByteWriteChannel;
  package$io.Condition = Condition;
  package$io.ByteChannelCoroutine = ByteChannelCoroutine;
  package$io.ByteChannel = ByteChannel_0;
  $$importsForInline$$['kotlinx-io-js'] = $module$kotlinx_io_js;
  package$io.ByteReadChannel_rq8efs$ = ByteReadChannel_2;
  Object.defineProperty(package$io, 'EmptyByteReadChannel', {
    get: get_EmptyByteReadChannel
  });
  package$io.joinTo_iw04lk$ = joinTo_0;
  package$io.copyTo_qm3w9g$ = copyTo_0;
  $$importsForInline$$['kotlinx-coroutines-io-js'] = _;
  ...
  package$io.discardExact_5joj65$ = discardExact;
  ...
  package$io.ReaderCoroutine = ReaderCoroutine;
  package$io.WriterCoroutine = WriterCoroutine;
  ...
  package$io_0.ByteChannel_6taknv$ = ByteChannel_1;
  package$io_0.ByteReadChannel_mj6st8$ = ByteReadChannel_3;
  package$io_0.ByteReadChannel_rq8efs$ = ByteReadChannel_4;
  ...
  ReaderJob.prototype.getCompletionException = Job.prototype.getCompletionException;
  ...
  ReaderJob.prototype.cancelChildren_dbl4no$ = Job.prototype.cancelChildren_dbl4no$;
  ReaderJob.prototype.invokeOnCompletion_ct2b2z$ = Job.prototype.invokeOnCompletion_ct2b2z$;
  ReaderJob.prototype.invokeOnCompletion_h883ze$ = Job.prototype.invokeOnCompletion_h883ze$;
  WriterJob.prototype.fold_3cc69b$ = Job.prototype.fold_3cc69b$;
  WriterJob.prototype.get_j3r2sn$ = Job.prototype.get_j3r2sn$;
  WriterJob.prototype.getCompletionException = Job.prototype.getCompletionException;
  ...
  WriterJob.prototype.cancelChildren_dbl4no$ = Job.prototype.cancelChildren_dbl4no$;
  WriterJob.prototype.invokeOnCompletion_ct2b2z$ = Job.prototype.invokeOnCompletion_ct2b2z$;
  WriterJob.prototype.invokeOnCompletion_h883ze$ = Job.prototype.invokeOnCompletion_h883ze$;
  Object.defineProperty(ReaderScope.prototype, 'isActive', Object.getOwnPropertyDescriptor(CoroutineScope.prototype, 'isActive'));
  Object.defineProperty(WriterScope.prototype, 'isActive', Object.getOwnPropertyDescriptor(CoroutineScope.prototype, 'isActive'));
  Kotlin.defineModule('kotlinx-coroutines-io-js', _);
  return _;
}));

//# sourceMappingURL=kotlinx-coroutines-io-js.js.map
